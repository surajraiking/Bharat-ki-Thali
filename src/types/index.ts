...
export type IndianRegion = 'North India' | 'South India' | 'West India' | 'East India' | 'Northeast India' | 'Central India' | 'Pan India';
export type GlobalRegion = IndianRegion | 'Asia' | 'Europe' | 'Africa' | 'North America' | 'South America' | 'Oceania' | 'Middle East';
export interface Ingredient { id:string; name:string; quantity:number; unit:string; optional?:boolean; notes?:string; }
export interface RecipeStep { id:string; stepNumber:number; title:string; instruction:string; durationMinutes?:number; image?:string; }
export interface Nutrition { calories:number; protein:number; carbohydrates:number; fat:number; fiber:number; }
export interface DishBenefit { title:string; description:string; }
export interface Dish {
  id:string; name:string; nameHindi:string; description:string; descriptionHindi?:string; image:string;
...
export interface ShoppingItem { id:string; dishId?:string; dishName?:string; name:string; quantity:number; unit:string; purchased:boolean; category?:string; }
export interface MealPlanDay { breakfast?:string; lunch?:string; dinner?:string; }
export interface WeeklyMealPlan { monday:MealPlanDay; tuesday:MealPlanDay; wednesday:MealPlanDay; thursday:MealPlanDay; friday:MealPlanDay; saturday:MealPlanDay; sunday:MealPlanDay; }
